...
//using System;
//using Utils = LightInDark.Utilities.Utils;
...
//                Utils.ShowCustomDisconnectWindow($"未找到更新脚本 {VersionMaker.UpdaterExeName}！\n请将其放置在游戏根目录下，否则无法正常检查更新。");
//                LightLogger.Log("154");
//            }
//            LightLogger.Log("155");
//        }
...
//                        break;
//                    case "no need":
//                        Utils.ShowCustomDisconnectWindow("当前已是最新版本。");
//                        break;
//                    case "not installed":
//                        Utils.ShowCustomDisconnectWindow("模组未安装。你咋点的检查更新并且看到这个窗口？\n也有可能是你把文件改名了，请改回去。");
//                        break;
//                    case "check error":
//                        Utils.ShowCustomDisconnectWindow("更新检查失败。\n请将游戏目录下的Light.log发送给开发者或者QQ群中。\n不要直接将此界面截图/拍照给其他人。");
//                        break;
//                    case "path error":
//                        Utils.ShowCustomDisconnectWindow($"未找到更新检查器！请检查你的目录下有无 {VersionMaker.UpdaterExeName} 。");
//                        break;
//                    case "github error":
//                        Utils.ShowCustomDisconnectWindow("无法访问GitHub来检查版本！请检查您的网络状况。\n当然，最坏的结果是我们删仓跑路了。");
//                        break;
//                    default:
//                        Utils.ShowCustomDisconnectWindow("未知返回值。\n请将游戏目录下的Light.log发送给开发者或者QQ群中。\n不要直接将此界面截图/拍照给其他人。");
