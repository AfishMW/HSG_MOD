...
public class VanillaImpostor : DefinedRole
{
    ...
    public VanillaImpostor() : base(
        Language.Translate("role.vanilla.impostor.name", "内鬼"),
        Color.Red,
        RoleCategory.Impostor,
        Language.Translate("role.vanilla.impostor.description", "基础内鬼职业，未分配自定义职业时的默认占位")) { }

    /// <summary>开场白：分配职业播报时显示在职业名底部</summary>
    public override string IntroBlurb => Language.Translate("role.vanilla.impostor.introBlurb", "暗中潜伏，伺机而动。");

    /// <summary>技能介绍：帮助详情立绘下方，多行用 \n 分隔</summary>
    public override string SkillDescription => Language.Translate("role.vanilla.impostor.skill", "击杀船员、破坏设施、钻管道。\n无模组专属技能。");
...
public class VanillaCrewmate : DefinedRole
{
    ...
    public VanillaCrewmate() : base(
        Language.Translate("role.vanilla.crewmate.name", "船员"),
        Color.Green,
        RoleCategory.Crewmate,
        Language.Translate("role.vanilla.crewmate.description", "基础船员职业，未分配自定义职业时的默认占位")) { }

    /// <summary>开场白：分配职业播报时显示在职业名底部</summary>
    public override string IntroBlurb => Language.Translate("role.vanilla.crewmate.introBlurb", "完成任务，揪出内鬼。");

    /// <summary>技能介绍：帮助详情立绘下方，多行用 \n 分隔</summary>
    public override string SkillDescription => Language.Translate("role.vanilla.crewmate.skill", "完成所有任务，发现并投票放逐内鬼。\n无模组专属技能。");
